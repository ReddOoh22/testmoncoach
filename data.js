...
const EXERCISE_LIBRARY = [
  ...
  { id: "pompes-genoux", name: "Pompes genoux", category: "haut", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "8-12 reps", defaultRest: 60, instructions: "Version plus accessible, corps aligne des genoux aux epaules." },
  { id: "elevations-laterales", name: "Elevations laterales", category: "epaules", equipment: ["haltere"], media: null, mediaType: "none", defaultTarget: "10-12 reps", defaultRest: 45, instructions: "Monte les bras sur les cotes sans hausser les epaules." },
  { id: "curl-biceps", name: "Curl biceps", category: "haut", equipment: ["haltere"], media: null, mediaType: "none", defaultTarget: "10-12 reps", defaultRest: 45, instructions: "Coudes pres du corps, mouvement controle." },
  { id: "extension-triceps", name: "Extension triceps", category: "haut", equipment: ["haltere"], media: null, mediaType: "none", defaultTarget: "10-12 reps", defaultRest: 45, instructions: "Controle la descente, sans cambrer." },
  { id: "rowing-elastique", name: "Rowing elastique", category: "dos", equipment: ["elastique"], media: null, mediaType: "none", defaultTarget: "12-15 reps", defaultRest: 45, instructions: "Tire les coudes vers l'arriere, omoplates actives." },
  { id: "split-squat", name: "Split squat", category: "jambes", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "8-10 reps par jambe", defaultRest: 60, instructions: "Petite amplitude si genou sensible." },
  { id: "wall-sit", name: "Chaise contre mur", category: "jambes", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "20-40 sec", defaultRest: 60, instructions: "Dos contre le mur, cuisses selon tolerance." },
  { id: "step-up", name: "Step-up", category: "jambes", equipment: ["banc"], media: null, mediaType: "none", defaultTarget: "8 reps par jambe", defaultRest: 60, instructions: "Monte sur un support stable. Stable, pas aventureux." },
  { id: "good-morning", name: "Good morning sans charge", category: "jambes", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "10-12 reps", defaultRest: 45, instructions: "Charniere de hanche douce, dos neutre." },
  { id: "planche-genoux", name: "Planche genoux", category: "gainage", equipment: ["tapis"], media: null, mediaType: "none", defaultTarget: "20-30 sec", defaultRest: 45, instructions: "Version allegee, abdos serres." },
  { id: "hollow-hold-simple", name: "Hollow hold simplifie", category: "gainage", equipment: ["tapis"], media: null, mediaType: "none", defaultTarget: "15-25 sec", defaultRest: 45, instructions: "Bas du dos proche du sol, version courte." },
  { id: "pallof-press", name: "Pallof press", category: "gainage", equipment: ["elastique"], media: null, mediaType: "none", defaultTarget: "8-10 reps par cote", defaultRest: 45, instructions: "Resiste a la rotation, buste stable." },
  { id: "cercles-epaules", name: "Cercles d'epaules", category: "mobilite", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "10 avant + 10 arriere", defaultRest: 0, instructions: "Mouvement lent, amplitude confortable." },
  { id: "rotations-bassin", name: "Rotations de bassin", category: "mobilite", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "10 rotations", defaultRest: 0, instructions: "Bouge doucement, sans forcer." },
  { id: "mobilite-chevilles", name: "Mobilite chevilles", category: "mobilite", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "10 par cote", defaultRest: 0, instructions: "Amplitude douce, surtout si ancienne entorse." },
  { id: "chat-vache", name: "Chat-vache", category: "mobilite", equipment: ["tapis"], media: null, mediaType: "none", defaultTarget: "8-10 reps", defaultRest: 0, instructions: "Mobilise la colonne sans violence theatrale." },
  { id: "ouverture-thoracique", name: "Ouverture thoracique", category: "mobilite", equipment: ["tapis"], media: null, mediaType: "none", defaultTarget: "8 par cote", defaultRest: 0, instructions: "Rotation lente du haut du dos." },
  { id: "etirement-pectoraux", name: "Etirement pectoraux", category: "etirement", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "30 sec par cote", defaultRest: 0, instructions: "Contre un mur, sans tirer comme un heros inutile." },
  { id: "posture-enfant", name: "Posture de l'enfant", category: "etirement", equipment: ["tapis"], media: null, mediaType: "none", defaultTarget: "45 sec", defaultRest: 0, instructions: "Respire lentement, relache le dos." },
  { id: "etirement-fessiers", name: "Etirement fessiers", category: "etirement", equipment: ["tapis"], media: null, mediaType: "none", defaultTarget: "30 sec par cote", defaultRest: 0, instructions: "Position confortable, aucune douleur vive." },
  { id: "etirement-quadriceps", name: "Etirement quadriceps", category: "etirement", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "30 sec par jambe", defaultRest: 0, instructions: "Bassin stable, genou tranquille." },
  { id: "etirement-mollets", name: "Etirement mollets", category: "etirement", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "30 sec par jambe", defaultRest: 0, instructions: "Talon vers le sol, sans rebond." },
  { id: "marche-active", name: "Marche active", category: "cardio", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "5-15 min", defaultRest: 0, instructions: "Rythme confortable, respiration maitrisable." },
  { id: "step-touch", name: "Step touch", category: "cardio", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "1-3 min", defaultRest: 30, instructions: "Pas lateral doux, sans saut." },
  { id: "circuit-doux", name: "Circuit doux sans saut", category: "cardio", equipment: ["poids-corps"], media: null, mediaType: "none", defaultTarget: "5-10 min", defaultRest: 60, instructions: "Enchainement simple, intensite basse a moderee." }
