...
function renderSettings() {
  ...
  renderShell(`
    ...
    <main class="screen">
      ...
      <section class="card compact stack"><h3>Version</h3><p class="small">Mon Coach v1.2.0 · PWA locale · GitHub Pages</p></section>
    </main>`);
}
...
function resetAllData() {
  ...
  state = { version: "1.2.0", introSeen: false, activeProfileId: null, profiles: [] };
  renderLanding();
}
